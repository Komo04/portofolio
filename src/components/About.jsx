        ...
        <article className=" text-white py-20 md:py-64">
            ...
            <div className=" max-w-4xl mx-auto px-6 text-center">
                ...
                <p className="text-base md:text-lg  mb-6">
                    ...
                    Saya memiliki pengalaman dalam membangun berbagai project seperti sistem informasi e-commerce, serta pengembangan UI/UX sederhana menggunakan teknologi seperti HTML, CSS, JavaScript, React, dan Laravel. Saya juga terbiasa bekerja dengan database MySQL.
